...
private:
  ...
  bool Needs_Rebuild(const std::vector<Camera_Parameter> &parameters) const;
  ...
  bool Collect_Updates(std::vector<Camera_Parameter_Update> *updates, wxString *error_message) const;
