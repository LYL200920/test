...
namespace robot_model
{
  ...
  public:
    ...
    void Update_Poses(const Matrix4 *world_from_flange,
  ...
  private:
    ...
    Coordinate_Frame_Renderer m_free_drag_handle_renderer{0.0, 16.0, false};
    ...
    bool m_has_interaction_pose = false;
