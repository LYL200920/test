...
namespace robot_model
{
  ...
  public:
    ...
    Collision_Index_Rebuild_Coordinator(const Collision_Index_Rebuild_Coordinator &) = delete;
    Collision_Index_Rebuild_Coordinator &operator=(const Collision_Index_Rebuild_Coordinator &) = delete;

    bool Submit_Source(Collision_Index_Build_Request request,
                       Dispatch dispatch,
                       Completion completion);
    bool Submit_Settings(Collision_Index_Build_Request request,
                         Dispatch dispatch,
                         Completion completion);
    void Reset();
    void Shutdown();
  ...
  private:
    bool Submit_Prepared(Collision_Index_Build_Request request,
                         Dispatch dispatch,
                         Completion completion);
