#ifndef includeguard_robot_model_panel_controller_h_includeguard
#define includeguard_robot_model_panel_controller_h_includeguard
...
private:
  ...
  void Apply_Progress_Run_Transition(
  ...
  void Apply_Robot_Actual_State(
    const application::Robot_Actual_State &state);
  void Refresh_Robot_Command_Controls(
...
private:
  ...
  std::shared_ptr<application::Robot_Connection_Controller>
    m_robot_connection;
  application::Robot_Connection_Controller::Observer_Token
  ...
  application::Robot_Connection_Status m_robot_connection_status;
