...
namespace robot_model
{
  ...
  namespace
  {
    ...
    bool apply_kr210_r2700_2_bounds_calibration(Robot_Assembly_Calibration &calibration,
                                                const Robot_Kinematic_Params &params,
  ...
  Robot_Assembly_Calibration Build_Assembly_Calibration(const Robot_Kinematic_Params &params, const std::string &model_name,
                                                        const std::vector<Robot_Visual_Part> &parts)
  {
