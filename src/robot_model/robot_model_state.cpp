...
void Robot_Model_State::Set_Current_Model (
  const Robot_Model_Info& model,
...
void Robot_Model_State::Set_Joint_State (
  const Robot_Joint_State& joint_state)
{
  m_joint_state = joint_state;
}

void Robot_Model_State::Set_Assembly_Calibration (
  const Robot_Assembly_Calibration& assembly_calibration)
{
