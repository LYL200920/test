...
bool Robot_Trajectory_Session::Start_Go_To (
  ...
  size_t frame_count)
{
  ...
  auto frames = Build_Joint_Ptp_Trajectory (
    current_angles, m_points[target_index], frame_count);
  if( frames.empty ( ) )
  {
    return false;
  }
...
const Robot_Trajectory_Session::Joint_Point*
Robot_Trajectory_Session::Step ( )
{
